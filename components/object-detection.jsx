    ...
    <div className="mt-8">
      {isLoading ? (
        ...
        <div>
          ...
          {/* Display detected objects and their disposal info */}
          <div className="mt-6">
            <h2 className="text-2xl font-bold">Detected Objects and Disposal Information</h2>
            {detectedObjects.length > 0 ? (
              ...
              <p className="mt-4">No objects detected yet.</p>
            )}
          </div>
        </div>
      )}
